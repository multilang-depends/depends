...
public class ASTStringUtil {
	...
	public static StringBuilder appendSignatureString(StringBuilder buffer, IASTDeclarator declarator) {
...
//			final ICASTDesignator[] designator= designatedInitializer.getDesignators();
	...
	public static StringBuilder appendDeclSpecifierString(StringBuilder buffer, IASTDeclSpecifier declSpecifier) {
