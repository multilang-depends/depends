...
Here is a quick example of the dependency relation generated by *depends* for the``` junit.framework``` files of  junit4 project(https://github.com/junit-team/junit4):

 ![JUnit elements relations](./doc/img/junit4framework.png)
